    ...
    <div class="container-fluid page-body-wrapper">
      ...
      <div class="main-panel">
            ...
            <div class="col-md-12 grid-margin">
              <div class="row">
                <div class="col-12 col-xl-8 mb-4 mb-xl-0">
                  <h3 class="font-weight-bold">List of Investigators</h3>
        ...
        <div class="head-title">
                <h4> </h4>
                <!-- <button type="submit" class="add btn btn-primary todo-list-add-btn" id="add-task"> <i class="icon-head menu-icon"></i> Add Investigator</button> -->
        </div>
