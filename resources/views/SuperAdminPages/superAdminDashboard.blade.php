    ...
    <div class="container-fluid page-body-wrapper">
      ...
      <div class="main-panel">
        <div class="content-wrapper">
            ...
            <div class="col-md-6 grid-margin transparent" id="box-numbers">
              <div class="row">
                ...
                <div class="col-md-6 mb-2 stretch-card transparent" id="box-numbers-items">
                  ...
                  <div class="card-box">
                    <div class="inner">
                    <p class="mb-4">No. Stations</p>
                      <p class="fs-30 mb-2">{{$num_stations}}</p>
                    </div>
                    <div class="icon">
               ...
               <div class="row">
                <div class="col-md-6 mb-2 mb-lg-0 stretch-card transparent" id="box-numbers-items">
                  ...
                  <div class="card-box">
                    <div class="inner">
                    <p class="mb-4">No. Investigators</p>
                      <p class="fs-30 mb-2">{{$num_investigators}}</p>
                    </div>
                    <div class="icon">
          ...
          <h3>List of Municipal Stations</h3>
