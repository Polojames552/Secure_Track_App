...
<div class="modal fade" id="downloadCar{{$data->id}}" tabindex="-1" role="dialog" aria-labelledby="exampleModalLongTitle" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <form id="scanForm" action="{{ route ('downloadCar', $data->id) }}" method="POST">
              @csrf
