...
<div class="modal fade" id="downloadProperty{{$data->id}}" tabindex="-1" role="dialog" aria-labelledby="exampleModalLongTitle" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <form id="scanForm" action="{{ route ('downloadProperty', $data->id) }}" method="POST">
              @csrf
