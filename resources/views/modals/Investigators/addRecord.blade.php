...
<!-- Modal -->
<div class="modal fade" id="addrecord" tabindex="-1" role="dialog" aria-labelledby="exampleModalLongTitle" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLongTitle">Types Evidence</h5>
      ...
      'Others' -->
      <div class="container">
        <div class="row" id="buttons-type">
                <button type="submit" class="add btn btn-warning todo-list-add-btn" id="evidence-button"> <i class="mdi mdi-chemical-weapon"></i> Forensic</button> 
                <button type="submit" class="add btn btn-info todo-list-add-btn" id="evidence-button"> <i class="mdi mdi-sword"></i> Weapons</button>
                <button type="submit" data-toggle="modal" data-target="#vehicles" class="add btn btn-primary todo-list-add-btn" id="evidence-button"> <i class="mdi mdi-car"></i> Vehicle</button>
                @include('modals/Investigators.vehicles')
                <button type="submit" class="add btn btn-success todo-list-add-btn" id="evidence-button"> <i class="mdi mdi-dots-vertical"></i> Others</button>
        </div>
      </div>
