    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title" id="exampleModalLongTitle"><b>Scan Motorcycle Records</b></h4>
        ...
        function scanQRCode() {
          ...
          setInterval(function() {
              ...
              if (code) {
                  ...
                  // $('#uuid').val(code.data);
                  deactivateScanner();
                  $('#scannerMotorcycle').modal('hide');
                  var uuid = "{{ route('scanner_motorcycle_record', '') }}/" + code.data;
                  $.ajax({
                    url: uuid,
                    method: "POST",
                    headers: {
