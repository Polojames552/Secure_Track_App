...
<div class="modal fade" id="addPropertyGoodsEvidence" tabindex="-1" role="dialog" aria-labelledby="exampleModalLongTitle" aria-hidden="true">
  <div class="modal-dialog modal-lg" role="document">
    <div class="modal-content">
      ...
      <form action="addProperty_Evidence" method="POST" enctype="multipart/form-data">
      @csrf
    ...
    <!-- <section style="padding-bottom:10px;">
      ...
      <!-- <label style="display: flex; justify-content: center; align-items: center; margin-bottom: -40px;" id="headlabel" for="inputEmail4"><b>Insert Picture</b></label> -->
