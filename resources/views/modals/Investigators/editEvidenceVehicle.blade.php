  ...
  <div class="modal-dialog modal-lg" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h4 class="modal-title" id="exampleModalLongTitle"><i class="mdi mdi-car"></i> <b>Edit Evidence - Vehicles</b> </h4>
        ...
        <table name="modal-table">
          <tbody>
            ...
            @if($data->bumper_front == "true")
                <td><input type="checkbox" id="bumper_front" name="bumper_front" value="bumper_front" checked> Bumper Front</td>
            @else
...
<td>
    ...
    @endif
              ...
              <tr>
                @if($data->front_coil_spring == "true")
                    <td><input type="checkbox" id="pitman_arm" name="pitman_arm" checked> Pitman Arm</td>
                @else
...
<td>
    <input type="checkbox" id="newly_painted" name="newly_painted" @if($data->brand_make == "true") checked @endif> Newly Painted
</td>
<td>
    <input type="checkbox" id="paint_discoloration" name="paint_discoloration" @if($data->brand_make == "true") checked @endif> Paint Discoloration
</td>
<td>
    <input type="checkbox" id="good_body_shape" name="good_body_shape" @if($data->brand_make == "true") checked @endif> Good Body Shape
</td>
<td>
    <input type="checkbox" id="body_in_bad_shape" name="body_in_bad_shape" @if($data->brand_make == "true") checked @endif> Body in Bad Shape
</td>
<td>
    <input type="checkbox" id="body_ongoing_repair" name="body_ongoing_repair" @if($data->brand_make == "true") checked @endif> Body ongoing repair
</td>
<td>
    <input type="checkbox" id="for_repainting" name="for_repainting" @if($data->brand_make == "true") checked @endif> For Repainting
</td>
            </tr>
            <tr>
            <td>
    <input type="checkbox" id="beyond_economical_repair" name="beyond_economical_repair" @if($data->brand_make == "true") checked @endif> Beyond Economical Repair and corrosion have set in, which requires a major body repair
</td>
            </tr>
          </tbody>
        </table>
