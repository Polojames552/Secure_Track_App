...
<!-- Modal -->
<div class="modal fade" id="addStations" tabindex="-1" role="dialog" aria-labelledby="exampleModalLongTitle" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLongTitle">Add Station</h5>
    ...
    <div class="avatar-upload">
        ...
        <div class="form-row">
            <div class="form-group col-md-12">
                ...
                <input type="text" class="form-control" name="municipality" id="municipality" placeholder="" value="" required>
            </div>
        </div>
        <div class="form-row">
            <div class="form-group col-md-12">
                <label id="headlabel" for="inputEmail4"><b>Municipal Director:</b></label>
                <input type="text" class="form-control" name="municipal_director" id="municipal_director" placeholder="" value="" required>
            </div>
        </div>
        <div class="form-row">
            <div class="form-group col-md-12">
