    ...
    <div class="container-fluid page-body-wrapper">
      ...
      <div class="main-panel">
        ...
        <div class="head-title">
                <h4> </h4>
                <button type="submit" data-toggle="modal" data-target="#addInvestigators" class="add btn btn-primary todo-list-add-btn" id="add-task"> <i class="icon-head menu-icon"></i> Add Investigator</button>
                @include('modals/MunicipalAdmin.modalAddInvestigators')
        </div>
        ...
        <tbody>
          @foreach($data as $data)
            <tr>
                ...
                @endif
               <td><button type="button" class="btn btn-success"data-toggle="modal" data-target="#editInvestigator{{$data->id}}"><i class="mdi mdi-lead-pencil"></i></button></td>
               @include('modals/MunicipalAdmin.editInvestigator')
            </tr>
          @endforeach
        </tbody>
    </table>
