  ...
  <div class="container-scroller">
    ...
    <nav class="navbar col-lg-12 col-12 p-0 fixed-top d-flex flex-row">
      <div class="text-center navbar-brand-wrapper d-flex align-items-center justify-content-center">
        <a class="navbar-brand brand-logo mr-5" href="dashboard"><img src="images/PNP.png" class="mr-2" alt="logo"  style="width:30px;height:40px;margin-left:8px;"/>Municipal Admin</a>
        <a class="navbar-brand brand-logo-mini" href="dashboard"><img src="images/PNP.png" alt="logo" style="width:40px;height:50px;"/></a>
      </div>
            ...
            <div class="col-md-12 grid-margin">
              <div class="row">
                <div class="col-12 col-xl-8 mb-4 mb-xl-0">
                  <h3 class="font-weight-bold">Municipal Admin Dashboard</h3>
    ...
    <div class="table-responsive">
        ...
        <tbody>
          @foreach($investigators as $investigators)
            <tr>
                <td>{{$investigators->id}}</td>
                <td>{{$investigators->name}}</td>
                <td>{{$investigators->municipality}}</td>
                <td>{{$investigators->municipal_director}}</td>
                <!-- <td>{{$investigators->address}}</td> -->
                <td>{{$investigators->username}}</td>
